...
namespace WordCount
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            This unified type hierarchy is called the Common Type System (CTS). For more information about inheritance in C#, see Inheritance. 
            ...
            Console.WriteLine("Indtast ordet der skal tælles:");
            string wordToCount = Console.ReadLine();

            WordCounter counter = new WordCounter();

            int occurrenceCount = counter.CountWordOccurrences(text, wordToCount);

            Console.WriteLine($"Ordet '{wordToCount}' forekommer i alt {occurrenceCount} gange.");
